...
#module load blast
export PATH=$PATH:/data/apps/user_contributed_software/ytao7/ncbi-blast-2.7.1+/bin
...
python /data/users/ytao7/software/buscoV3/scripts/run_BUSCO.py -o $genome_name -i $assembly_fasta -l /data/users/ytao7/software/buscoV3/mammalia_odb9 -m geno -c $CORES -r -f
